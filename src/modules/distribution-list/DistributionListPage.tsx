...
const DATA_STORE: Record<string, any> = {
    'apr2-apr15': {
        ...
        "AGING_TICKETS": [
        {
                ...
                "date": "2026-04-07",
                "subject": "CRM Dashboard open for Maya Ni",
                "comment": "等Maya找IT 确认账号后再开通权限"
        }
],
        "ASSIGNEE_WORKLOAD": [
                {
        ...
        "EFFICIENCY_STATS": [
        {
                ...
                "totalHours": 20.3,
                "avgTime": 0.45,
                "topCategory": "China Data Portal (26单)"
        },
        {
                "name": "Winni Luo",
                "tickets": 13,
                "totalHours": 9.75,
                "avgTime": 0.75,
                "topCategory": "China Data Platform (12单)"
        }
],
        ...
        "insight_top_req": "通过四月上半程数据分析，整体服务水平稳定上升。",
        "insight_scale": "ST表格数据显示两人分别处理了大量不同类别的核心CI应用单据。",
        "insight_depth": "Data Portal 和 Control Tower 依然是影响解决时间的重点。"
},
    'mar4-mar18': {
...
export const DistributionListPage: React.FC = () => {
    ...
    const [viewKey, setViewKey] = useState<string>('apr2-apr15'); // 当前看板绑定的大脑神经元状态
        ...
        <div id="report-root" className={`min-h-screen ${pageConfig.bgColor} pb-24 font-sans text-slate-800 focus:outline-none relative transition-colors duration-1000`}>
            ...
            <div className="max-w-[1240px] mx-auto px-6 space-y-12">
                ...
                <div className="bg-[#f8fafc] rounded-2xl p-12 border border-slate-200 shadow-sm">
                    <div className="flex items-center gap-4 mb-10"><div className="w-1.5 h-8 bg-[#0a1e40] rounded-full" /><div><h2 className="text-2xl font-bold text-[#0a1e40] tracking-tight">Resolution Efficiency Deep-Dive</h2><p className="text-slate-500 text-sm mt-1">Comparative analysis based on Apr 2 - Apr 15 Actual Resolution Time (Analyzing a total of 274 tickets)</p></div></div>
